...
var rules = {
  ...
  samePlayerCantMoveTwice: function samePlayerCantMoveTwice(_ref2) {
    ...
    var _moves$reverse = moves.reverse(),
        _moves$reverse2 = (0, _toArray3.default)(_moves$reverse),
  ...
  win: function win(_ref4) {
    ...
    var result = R.values(givenPlayerMoves([move].concat((0, _toConsumableArray3.default)(movesOfThisPlayer)))).some(function (a) {
      return a;
    });
